  ...
  const features = [
    {
      ...
      description: "Disponibilidad inmediata para grandes volúmenes",
      icon: CheckCircle2,
      color: "emerald"
    },
    {
      title: "Envíos Rápidos",
      description: "Despacho a todo Chile en 24/48 horas",
      icon: Truck,
      color: "blue"
    },
    {
      title: "Eco-Friendly",
      description: "Productos libres de cobalto y no tóxicos",
      icon: Leaf,
      color: "green"
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center max-w-7xl mx-auto">
            ...
            <div className="space-y-10 flex flex-col gap-3">
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-emerald-100/80 leading-relaxed max-w-xl">
                Proteja sus productos y equipos con Silica Gel de alta pureza. 
