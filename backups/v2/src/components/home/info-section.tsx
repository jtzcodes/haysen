          ...
          <div className="space-y-10">
            ...
            <div className="grid gap-6">
              <Card className="border-l-4 border-l-blue-500 shadow-sm hover:shadow-md transition-shadow">
                <CardHeader className="pb-2">
                  <div className="flex items-center justify-between">
                    <CardTitle className="text-blue-700">Silica Gel Azul</CardTitle>
                    <Info className="h-5 w-5 text-blue-400" />
                  </div>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-slate-600 mb-3">
                    Contiene cloruro de cobalto como indicador. Ideal para aplicaciones industriales no alimentarias.
                  </p>
                  <div className="flex items-center gap-2 text-xs font-semibold bg-blue-50 text-blue-800 w-fit px-2 py-1 rounded">
                    Cambio de color: Azul → Rosado
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-l-4 border-l-amber-500 shadow-sm hover:shadow-md transition-shadow">
                ...
                <CardContent>
                  <p className="text-sm text-slate-600 mb-3">
                    Libre de metales pesados (Eco-Friendly). Apta para industria farmacéutica y alimentaria.
                  </p>
