...
import { Check, ShoppingCart, Package, Droplets, Leaf, Factory, LucideIcon, Minus, Plus, ImageIcon } from "lucide-react"
...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <Card className="flex flex-col overflow-hidden border-border/50 bg-white shadow-sm hover:shadow-md transition-all duration-300 h-full group">
      ...
      <Link href={`/productos/${product.slug}`} className="block w-full h-48 bg-slate-50 relative overflow-hidden shrink-0 cursor-pointer">
        ...
        <div className="mt-auto space-y-4">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-slate-100 gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-slate-400 font-medium">Neto</span>
            </div>
