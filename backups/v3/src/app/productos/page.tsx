...
export const metadata: Metadata = {
  ...
  description: "Compre Silica Gel Azul, Naranja y Blanca por Kilo o Saco. Catálogo actualizado 2026 con precios y stock en tiempo real. Despacho a todo Chile.",
}
