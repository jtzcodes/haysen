...
export const metadata: Metadata = {
  title: "Venta de Silica Gel y Desecantes Industriales | Envíos a todo Chile",
  description: "Líderes en venta de Silica Gel Azul, Naranja y Blanca. Soluciones certificadas para control de humedad en minería, farmacéutica y exportación. Cotice online.",
}
