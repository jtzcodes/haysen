...
export const metadata: Metadata = {
  title: "Catálogo de Silica Gel 2026 | Precios Mayoristas",
  description: "Silica Gel Naranja, Blanca y Alúmina Activada. Catálogo actualizado 2026. Despacho a todo Chile.",
}
    ...
    <div className="flex flex-col">
      ...
      <section className="py-16 bg-white min-h-[60vh]">
        <div className="container mx-auto px-4">
          ...
          {/* Grid de Productos (Vertical en móvil, Grid en desktop) */}
          {products.length > 0 ? (
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-slate-600">
                <div className="p-4 bg-white rounded-xl border border-slate-100 shadow-sm">
                  ...
                  <p className="text-sm">La opción ecológica y moderna. Libre de cobalto, ideal para exportación y uso general. Cambia de color al saturarse.</p>
                </div>
                <div className="p-4 bg-white rounded-xl border border-slate-100 shadow-sm">
                  <h3 className="font-semibold text-slate-700 mb-2">Silica Gel Blanca</h3>
                  <p className="text-sm">La opción más económica. Perfecta para sachets pequeños, farmacéutica y aplicaciones donde no se requiere indicador visual.</p>
                </div>
                <div className="p-4 bg-white rounded-xl border border-slate-100 shadow-sm">
                  <h3 className="font-semibold text-emerald-700 mb-2">Alúmina Activada</h3>
                  <p className="text-sm">Para uso industrial pesado. Resistente al agua líquida y altas temperaturas. Ideal para secadores de aire comprimido.</p>
                </div>
              </div>
            </div>
